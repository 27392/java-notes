package cn.haohaoli.book.core.base.chapter6.interfaces.innerClass;

import cn.haohaoli.book.core.base.chapter6.interfaces.Employee;
...
public class InnerClassTest {
    ...
    public static void main(String[] args) {
        ...
        // 静态内部类
        OuterClass.Inner staticInner = new OuterClass.Inner("明明");
...
class OuterClass {
    ...
    public class InnerClass {
        ...
        public void print() {
             ...
             *      外部类.this.成员方法
             */
            System.out.println("OuterClass:radius : " + OuterClass.this.radius);
            System.out.println("InnerClass:radius : " + radius);               //外部类的private成员
