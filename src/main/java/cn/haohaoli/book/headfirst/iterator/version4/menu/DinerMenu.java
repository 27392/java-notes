...
import cn.haohaoli.book.headfirst.iterator.version4.impl.DinerMenuIterator;
...
public class DinerMenu implements Menu {
    ...
    public void addItem(String name, String description, boolean vegetarian, double price) {
        ...
        menuItems[numberOfItems++] = new MenuItem(name, description, vegetarian, price, MenuType.LUNCH);
    }
